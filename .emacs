...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (dumb-jump dired-narrow ibuffer-projectile ibuffer-tramp ibuffer-vc flycheck-mypy terraform-mode rust-mode nix-buffer nix-mode yapfify dhall-mode thrift markdown-mode lua-mode smartparens f psc-ide web-mode yasnippet zoom-frm yaml-mode wgrep-ag web-beautify w3m urlenc tup-mode tuareg tss tracking tidy string-inflection smart-tab shorten shm sass-mode request-deferred purescript-mode projectile-ripgrep popwin ob-restclient multi-term magit lorem-ipsum less-css-mode js2-mode intero iedit ht hindent hi2 hexrgb hemisu-theme helm-projectile graphviz-dot-mode goto-last-change go-mode git-timemachine flx-ido feature-mode exec-path-from-shell evil ess enh-ruby-mode elisp-slime-nav edit-server edit-color-stamp dockerfile-mode cucumber-goto-step crontab-mode column-marker coffee-mode birds-of-paradise-plus-theme better-defaults ample-zen-theme ample-theme alert alchemist ag ace-jump-mode)))
