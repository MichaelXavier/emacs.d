...
(custom-set-variables
 ...
 '(erc-autojoin-channels-alist (quote (("freenode.net" "#purescript" "#emacs" "#haskell" "#nothaskell" "#atunit" "##guitar"))))
