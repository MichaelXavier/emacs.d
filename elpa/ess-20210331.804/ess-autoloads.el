...
(register-definition-prefixes "ess-r-mode" '("R-" "ess-" "inferior-ess-r-" "run-ess-r-newest"))
...
If called interactively, toggle `Ess-Roxy mode'.  If the prefix
...
(register-definition-prefixes "ess-s-lang" '("ess-" "inferior-S-language-start" "s-"))
...
If called interactively, toggle `Ess-Elisp-Trace mode'.  If the
